...
async function sendWelcomeEmail(name, email) {
  if (!RESEND_API_KEY.startsWith("re_")) return; // skip if not configured
  try {
    await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from:    FROM_EMAIL,
        to:      email,
        subject: "Welcome to VertiCliff",
        html: `
          <div style="font-family:Georgia,serif;background:#06080f;color:#e2ddd4;padding:40px;max-width:560px;margin:0 auto;border-radius:8px;">
            <div style="border-left:3px solid #6366f1;padding-left:16px;margin-bottom:28px;">
              <div style="font-size:10px;letter-spacing:0.3em;color:#6366f1;text-transform:uppercase;margin-bottom:4px;">Engineered for the Hook</div>
              <div style="font-size:22px;font-weight:700;color:#fff;">VERTICLIFF</div>
            </div>
            <p style="font-size:16px;color:#e2ddd4;margin-bottom:16px;">Hi ${name},</p>
            <p style="font-size:14px;color:#9ca3af;line-height:1.8;margin-bottom:16px;">
              You're in. Your VertiCliff workspace is ready.
            </p>
            <p style="font-size:14px;color:#9ca3af;line-height:1.8;margin-bottom:24px;">
              Start by writing your premise — the single sentence that defines your entire story. Everything in the framework flows from that one line.
            </p>
            <div style="background:#0a0d1c;border:1px solid #1e2535;border-radius:6px;padding:16px;margin-bottom:28px;">
              <div style="font-size:11px;color:#6366f1;letter-spacing:0.2em;text-transform:uppercase;margin-bottom:10px;">What's inside</div>
              <div style="font-size:13px;color:#9ca3af;line-height:2;">
                ✦ 22 ARCH universal beats<br/>
                ✦ 8 genre-specific beats (Crime · Thriller · Love)<br/>
                ✦ 90-second episode structure<br/>
                ✦ Series Story Board<br/>
                ✦ Series Arc Graph
              </div>
            </div>
            <p style="font-size:12px;color:#374151;line-height:1.7;">
              Questions? Reply to this email or reach us at <a href="mailto:${SUPPORT_EMAIL}" style="color:#6366f1;">${SUPPORT_EMAIL}</a>
            </p>
            <p style="font-size:11px;color:#1e2535;margin-top:24px;">
              © VertiCliff · Beta · You're receiving this because you created an account.
            </p>
          </div>
        `,
      }),
